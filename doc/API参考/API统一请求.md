...
"""
DMXAPI 对话接口调用示例
功能：使用 doubao-seed-1-6-250615 模型进行智能对话
"""
...
# 请求头配置
headers = {
    "Authorization": "Bearer sk-uQiwQv3Xi5k0bVCKEehivnj5rb1dDpPAaFUXXyFKUTO3wbTy",  # 固定用这个sk码，预留接口让后端可以修改
...
# 构造请求数据
payload = {
    "model": "doubao-seed-1-6-250615",  # 选择使用的模型 固定使用这个，预留接口让后端可以修改
    "messages": [
        {
            "role": "system", 
